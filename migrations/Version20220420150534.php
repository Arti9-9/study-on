 ...
 */
final class Version20220420150534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT NOT NULL, character_code VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(1000) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_169E6FB960E92400 ON course (character_code)');
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, cours_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, number INT NOT NULL, PRIMARY KEY(id))');
